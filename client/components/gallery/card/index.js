...
const Card = ({ item }) => {
  ...
  const { toggleFavorites, download, saved, isDownloading, isLiking } = usePhoto(item)
  const image = useRef()
          ...
          <div className='card'>
            ...
            <div className='card-info'>
              ...
              <div className='card-buttons'>
                ...
                >
                  {saved ? <MdFavorite size={30} color='red' /> : isLiking ? <MdFavorite size={30} color='gray' /> : <MdFavorite size={30} />}
                </div>
